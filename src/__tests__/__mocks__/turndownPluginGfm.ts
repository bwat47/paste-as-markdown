// Simple mock for @bwat47/turndown-plugin-gfm that provides basic table & task list functionality for tests.
// Minimal explicit types instead of any to satisfy lint rules.

type Filter = string | string[] | ((node: Element) => boolean);
...
export function gfm(service: TurndownServiceLike): void {
